  ...
  return (
    <div className="max-w-6xl mx-auto p-6 lg:p-10 space-y-8 bg-gray-50/50 min-h-screen text-left">
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-black text-gray-800 tracking-tight text-left">Support Tickets</h1>
          <p className="text-gray-500 text-sm text-left">Manage and track your active support requests.</p>
        </div>
      ...
      <div className="space-y-4">
        ...
        {tickets.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border-2 border-dashed border-gray-200">
            ...
            <p className="text-gray-500 font-medium text-lg text-left">No tickets found</p>
