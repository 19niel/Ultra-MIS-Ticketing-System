        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm flex flex-col items-center text-center">
            <div className="relative group">
              <div className="w-32 h-32 bg-blue-600 to-black text-white rounded-[2.5rem] flex items-center justify-center text-4xl font-black shadow-xl ring-4 ring-white">
                {initials || "U"}
              </div>
